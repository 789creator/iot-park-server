...
import com.szzt.iot.generator.entity.ColumnEntity;
import com.szzt.iot.generator.entity.TableEntity;
...
public class GenUtils {
	...
	public static void generatorCode(Map<String, String> table,
		...
		for(String template : templates){
			...
			try {
				...
				throw new RobotException("渲染模板失败，表名：" + tableEntity.getTableName(), e);
			}
		}
	}
	...
	public static Configuration getConfig(){
		try {
			...
			throw new RobotException("获取配置文件失败，", e);
		}
	}
