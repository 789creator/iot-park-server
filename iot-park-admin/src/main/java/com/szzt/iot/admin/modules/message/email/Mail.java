...
public class Mail {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 定义连接imap服务器的属性信息
        String port = "993";
        String imapServer = "imap.139.com";
        String protocol = "imap";
//        String username = "121932593@qq.com";
        String username = "18569080390@139.com";
//        String password = "efmlgeqqxpmsbhgf"; // QQ邮箱的授权码
        String password = "Zhj121932593"; // QQ邮箱的授权码
