...
package com.szzt.iot.common.constant;
...
public class SysConstant {
     ...
     * 消息队列名称
     */
    public static final String CLIENT_QUEUE_NAME ="robot.to.client.script.python.Queue";
    public static final String SERVER_QUEUE_NAME ="robot.to.server.script.python.Queue";
